...
Gha_2013 <- read_dta("Ghana 2013 Services.dta")
Nig_2014 <- read_dta("Nigeria 2014 Services.dta")
SA_2007 <- read_dta("~South Africa 2007 Services.dta")
Tan_2013 <- read_dta("~Tanzania 2013 Services.dta")
Ken_2018 <- read_dta("~Kenya 2018 Services.dta")
Nig_Tech <- read_csv("~One campaign data ful set.csv")
